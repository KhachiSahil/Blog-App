...
import { SignupType } from "sahil-common-blog";
        ...
        <div className="h-screen flex justify-center flex-col">
            <div className="flex justify-center">
                <div>
                    ...
                    <div className="pt-8">
                        {type === "signup" && (
                            <LabelledInput label="Name" placeholder="Sahil Khachi..." onChange={(e) => {
                                setPostInputs({
                                    ...postInputs,
                                    name: e.target.value
                                });
                        ...
                        <LabelledInput label="Email" placeholder="sahil@gmail.com" onChange={(e) => {
                            setPostInputs({
                                ...postInputs,
